...
> **Документ неактуален.** Актуальные описания для заказчика и стейкхолдеров:
> - **Что входит в первый этап (MVP):** [mvp_scope_ru.md](mvp_scope_ru.md)
> - **Функционал приложения (кратко):** [functionality_brief_ru.md](functionality_brief_ru.md)
...
Дополнительно: [Почему эта система нужна молодежному служению сегодня](why.html)
...
flowchart TD
    subgraph analytics [Дашборд лидера]
        direction TB
        Header["Аналитика группы: Минская молодежь"]
...
flowchart TD
    subgraph admin_panel [Панель администратора]
        ...
        GroupList --> Grp1["Минская молодежь - Лидер: Андрей"]
        GroupList --> Grp2["Могилевская молодежь - Лидер: Отари"]
...
См. также: [Почему эта система нужна молодежному служению сегодня](why.html)
